...
public class AuthControllerTest {
	...
	public void testAuthenticateUser() {
		...
		loginRequest.setUsername("debaprasad89");
		loginRequest.setPassword("debaprasad89");
	...
	public void testRegisterUsertWithExistingUser() {
		...
		signUpRequest.setUsername("debaprasad89");
		signUpRequest.setPassword("debaprasad89");
		signUpRequest.setEmail("debaprasad89@gmail.com");
		rolelist.add(role);
...
//		assertNotNull(responseEntity1);
	...
	@Test
	public void testRegisterUserWithDefaultUserAuthor() {
...
//		role.setId(1);
		...
		// Create new user's account
				...
				Set<String> strRoles = signUpRequest.getRole();
				Set<Role> roles = new HashSet<>();
				//when(signUpRequest.getRole()).thenReturn(rolelist);
				
				Role readerRole = new Role();
				readerRole.setName(ERole.ROLE_AUTHOR);
				
				Optional<Role> optioanl=Optional.of(readerRole);
				when(roleRepository.findByName(ERole.ROLE_AUTHOR)).thenReturn(optioanl);
				ResponseEntity responseEntity=ResponseEntity.ok(new MessageResponse("Author"+"  registered is  successfully!"));
				ResponseEntity responseEntity1=authController.registerUser(signUpRequest);
                assertNotNull(responseEntity1);
	}
